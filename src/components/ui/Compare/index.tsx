...
import { AbsoluteContainer, ClipContainer, CompareContainer, HandleContainer, InnerImage, KnobContainer } from 'components/styled/compare';
...
export default function Compare({ children }) {
  ...
  const resizing = (_e, _dir, refToElement) => {
